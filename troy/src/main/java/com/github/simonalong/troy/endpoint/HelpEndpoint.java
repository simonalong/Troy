...
public class HelpEndpoint {
    ...
    public String getList() {
        ...
        apiMessage.append("变更：更新分组信息          ").append("curl " + withJson() + " '" + apiPrefix() + "/group?group={group}&printLogLevel={logLevel}&enable={enable}'").append("\n");
        apiMessage.append("变更：某个函数更新          ").append("curl " + withJson() + " '" + apiPrefix() + "/group/fun/change?funId={funId}&printLogLevel={logLevel}&enable={enable}'").append("\n");
        ...
        apiMessage.append("输出变更：添加分组输出      ").append("curl " + withJson() + " '" + apiPrefix() + "/group/(console/file/all)?group={group}&printLogLevel={logLevel}&enable={enable}'").append("\n");
        apiMessage.append("输出变更：添加函数输出      ").append("curl " + withJson() + " '" + apiPrefix() + "/group/fun/print/(console/file/all)?funId={funId}&printLogLevel={logLevel}&enable={enable}'").append("\n");
        ...
        apiMessage.append("更新：logger更新级别        ").append("curl " + withJson() + " '" + apiPrefix() + "/logger/appender/(console/file/all)?loggerName={loggerName}&logLevel={logLevel}'").append("\n");
        apiMessage.append("更新：logger处理恢复        ").append("curl " + withJson() + " '" + apiPrefix() + "/logger/restore/all/info?loggerName={loggerName}&logLevel={logLevel}'").append("\n");
